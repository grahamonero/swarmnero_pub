...
// applies the new version on the next launch. Listen for update-ready
// events and show a banner with a Restart button so users can pick up
// the update without waiting for a future relaunch.
//
// The callback form of Pear.updates() fires immediately when an update
// is already queued at subscribe time, which the stream-on('data') form
// can miss in some runtime variants.
