...
import { isValidReactionEmoji } from './events.js'

// Drop events whose on-wire shape fails a per-type sanity check. Runs in
// addition to signature verification: a signed event can still be malformed.
// Returning false silently discards the event from ingest.
